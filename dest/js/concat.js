...
function getViewportScroll() {
  ...
  doc = (_readOnlyError("doc"), doc.clientHeight ? doc : document.body);
  ...
  _createClass(ImageSlider, [{
    ...
    value: function generateImageSlider() {
      ...
      if (this.default.type === "slide") {
        ...
        for (var _i = 0; _i < this.slidesLength; _i++) {
          console.log(_i);
          $(this.slides[_i]).css({
            "-webkit-transform": "translate(" + _i * 100 + "%, 0);",
            "-moz-transform": "translate(" + _i * 100 + "%, 0);",
            "-ms-transform": "translate(" + _i * 100 + "%, 0);",
            "-o-transform": "translate(" + _i * 100 + "%, 0);",
            "transform": "translate(" + _i * 100 + "%, 0);"
          });
        }
      }
...
$(".other-skills-toggle").on("click", function () {
  $(".other-skills").toggleClass("collapse");
  $(".fa-arrow-down").toggleClass("collapse"); //$(".other-skills-wrapper").slideShow(4000,'easeOutQuart');
