...
(function (d) {
  ...
  f("y", !0);
  l.prototype = {
    setFromString: function setFromString(a, b) {
    ...
    setter: {
      ...
      perspective: function perspective(a) {
  ...
  d.fn.transition = d.fn.transit = function (a, b, c, f) {
    ...
    if (0 === k) return b = j, c = function c(b) {
      h.css(a);
      f && f.apply(h);
      b && b();
...
$(document).ready(function () {
  ...
  var imagesCover = [].slice.call(document.querySelectorAll('.js-parallax-bg-cover'));
...
function toggleNavbar() {
  ...
  $(".nav-icon__line__left").toggleClass("nav-icon-active"); // $(".nav-icon__line__left").addClass("up-bar-change");
...
/*#__PURE__*/
function () {
  function ImageSlider(el, prev, next, options) {
  ...
  _createClass(ImageSlider, [{
    key: "generateImageSlider",
    value: function generateImageSlider() {
      var _this = this;
      ...
      if (this.options.type === "slide") {
        ...
        for (var _i2 = 0; _i2 < this.slidesLength; _i2++) {
          console.log(_i2);
          $(this.slides[_i2]).css({
            "-webkit-transform": "translate(" + _i2 * 100 + "%, 0);",
            "-moz-transform": "translate(" + _i2 * 100 + "%, 0);",
            "-ms-transform": "translate(" + _i2 * 100 + "%, 0);",
            "-o-transform": "translate(" + _i2 * 100 + "%, 0);",
            "transform": "translate(" + _i2 * 100 + "%, 0);"
          });
        }
      }
...
var slide = new ImageSlider('.carousel__content', '.nav-left', '.nav-right');
$(".other-skills-toggle--current").on("click", function () {
  $(".other-skills--current").toggleClass("collapse");
  $(".other-skills-toggle__arrow--current").toggleClass("collapse");
});
$(".other-skills-toggle--future").on("click", function () {
  ...
  $("#submit").on("click", function () {
    ...
    if (check_name() && check_mail() && check_text()) {
      $.post("send.php", {
        ...
        $('#contact-form')[0].reset(); // $("#contact-name").removeClass("not-correct");
...
function check_mail() {
  ...
  if (name == '') {
    ...
    $("#topic-valid").show("bounce", {
      direction: 'up'
    }, "ease", 3000); // $("#contact-mail").addClass("is-invalid");
